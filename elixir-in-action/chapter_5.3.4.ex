...
# CREATE
# TodoServer.add_entry(todo_server, %{date: ~D[2018-12-19], title: "Dentista"})
# TodoServer.add_entry(todo_server, %{date: ~D[2018-12-20], title: "Shopping"})
# TodoServer.add_entry(todo_server, %{date: ~D[2018-12-19], title: "Filmes"})

# READ
# TodoServer.entries(todo_server, ~D[2018-12-19])

# UPDATE
# TodoServer.update_entry(todo_server, 1, &Map.put(&1, :date, ~D[2018-12-19]))
